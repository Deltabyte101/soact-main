...
@section('content')
    ...
    <!-- Modal -->
    <form class="modal fade" id="addclubs" enctype="multipart/form-data" tabindex="-1" aria-labelledby="addclubs" aria-hidden="true"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body form-sample">
                    ...
                    <div class="form-group">
                        <label for="file">เลือกโลโก้ประจำชมรม</label>
                        <input type="file" class="form-control" name="picture" >
                    </div>
                    <div class="form-group">
                        <label for="file">QR Code สำหรับการติดต่อชมรม</label>
