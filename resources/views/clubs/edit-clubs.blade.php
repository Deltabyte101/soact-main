        ...
        <div class="row my-3">
            <div class="col-12">
                <form action="{{ route('clubs.update', ['club' => $club->id]) }}" method="POST" class="update">
                    ...
                    <div class="form-group">
                        <label >โลโก้ประจำชมรม</label>
                        <img  src="{{ Storage::url( $club->picture)  }}"
                        style="object-fit:none;
                        object-position: mid;
                        width:100%;
                        height:auto;"/>

                        <!-- <label for="file">โลโก้ประจำชมรม</label>
                        <input type="file" class="form-control" name="picture" id="picture" > -->
                    </div>
                    <div class="form-group">
                        <label for="file">QR สำหรับติดต่อชมรม</label>
                        <img  src="{{ Storage::url( $club->QR)  }}"
                        style="object-fit:none;
                        object-position: mid;
                        width:100%;
                        height:auto;"/>
